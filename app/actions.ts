...
const recommendationsDatabase: Record<string, RecommendationsData> = {
  米津玄師: {
    artists: [
      {
        name: "キング・ヌー",
...
// BTSのデータベース内の画像も更新
recommendationsDatabase["BTS（防弾少年団）"].artists[0].imageUrl = "https://www.seventeen-17.com/img/top/main_pc.jpg"
recommendationsDatabase["BTS（防弾少年団）"].artists[1].imageUrl = "https://www.twicejapan.com/img/top/main_pc.jpg"
recommendationsDatabase["BTS（防弾少年団）"].artists[2].imageUrl = "https://enhypen.jp/img/top/main_pc.jpg"
recommendationsDatabase["BTS（防弾少年団）"].artists[3].imageUrl = "https://straykidsjapan.com/img/top/main_pc.jpg"
recommendationsDatabase["BTS（防弾少年団）"].artists[4].imageUrl = "https://www.blackpinkmusic.com/img/top/main_pc.jpg"
